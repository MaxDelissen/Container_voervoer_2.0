...
public static class ContainerGeneratorHelper
{
    public static List<Container> GenerateRandomContainers()
    {
        while (true)
        {
            ...
            var containers = generator.GenerateRandomContainers(amounts[0], amounts[1], amounts[2], amounts[3]);
    ...
    public static List<Container> GenerateContainersWithWeight()
    {
        ...
        var generator = new ContainerGenerator();
        var containers = generator.GenerateContainersWithWeight( //CooledValuable, Valuable, Cooled, Normal
    ...
    public static List<Container> GenerateContainersManually()
    {
        ...
        while (true)
        {
            Container newContainer = RequestContainer();
    ...
    private static Container RequestContainer()
    {
        ...
        var type = GetValidatedEnumInput<ContainerType>("Type: ");
